...
from app.handlers import admin_arenas, admin_cards, admin_chemistry, admin_panel, admin_rating, admin_security, admin_settings, admin_users, admin_wallets, broadcast, clan_wars, community, bulk_cards, creators, daily_login, promo, seasons, events, free_card, hockey_pass, lineup, matches, menu, packs, profile, quests, rating, shop, start, starter_kit, user_cards
