...
Здесь можно вручную выдать донат до подключения платёжного провайдера.
Для покупки игрок пишет @teyld, после оплаты выбери игрока → Energy → «Начислить».

Также здесь можно пополнять или списывать остальные валюты.
