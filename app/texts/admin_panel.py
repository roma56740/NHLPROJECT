...
🗄 файл базы данных
🖼 архив карт и изображений

Карты в архиве раскладываются по коллекциям, позициям и OVR, чтобы их было проще переносить и проверять.
""".strip()
...
Контент-админ может загружать и редактировать карты, боксы, дивизионы, картинки, зарплаты и химию, но не может трогать пользователей, валюты, базу и выдачу админки.
""".strip()
...
ADMIN_UPLOADS_NOT_FOUND_TEXT = "🖼 Картинок для архива пока нет."
