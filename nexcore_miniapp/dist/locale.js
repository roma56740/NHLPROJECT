(() => {
  ...
  const exact = new Map(Object.entries({
    ...
    'Gift Week': 'Неделя подарков',
    '7 days of gifts · Daxon Rudolph 97 is already yours.': '7 дней подарков · Daxon Rudolph 97 уже у тебя.',
    '7 days · one daily claim': '7 дней · один подарок в день',
    'WELCOME GIFT': 'ПОДАРОК НА СТАРТЕ',
    'The card has already been added to your collection.': 'Карта уже добавлена в твою коллекцию.',
    'Open the event to receive the card automatically.': 'Открой событие — карта будет выдана автоматически.',
    'Gift Week has ended.': 'Неделя подарков завершена.',
    'Today’s gift is already claimed. Come back tomorrow.': 'Сегодняшний подарок уже получен. Возвращайся завтра.',
    'All seven daily gifts are claimed.': 'Все семь подарков получены.',
    ...
    'Chemistry': 'Химия',
    'No active chemistry bonuses.': 'Активных бонусов химии пока нет.',
    'Gift Week Rudolph counts as Sharks, Rangers, Montreal and Chicago for chemistry.': 'Rudolph из Недели подарков считается игроком Sharks, Rangers, Montreal и Chicago для химии.',
    'cards': 'карт',
    'required': 'нужно',
    ...
    'Promo code': 'Промокод',
    'Activate a reward code': 'Активировать код награды',
    'Enter a code to receive its server-side reward': 'Введи промокод, чтобы получить награду',
    'Activate promo code': 'Активировать промокод',
    'Enter a promo code': 'Введи промокод',
    'A code can grant Coins, BP for the Fireside Pass or a pack. Limits and expiry are validated by the server.': 'Промокод может выдать монеты, BP для Fireside Pass или пак. Лимиты и срок действия проверяются сервером.',
    'Free card': 'Бесплатная карта',
    'Claim a random card on cooldown': 'Забрать случайную карту по таймеру',
    'FREE DROP': 'БЕСПЛАТНАЯ КАРТА',
    'Claim free card': 'Забрать бесплатную карту',
    'Not ready yet': 'Пока недоступно',
    'Free card unavailable': 'Бесплатная карта недоступна',
    'The free-card pool is configured by admins.': 'Пул бесплатных карт настраивается администраторами.',
    'Black Market': 'Чёрный рынок',
    'Personal daily storefront': 'Личная ежедневная витрина',
    'Personal daily offers and cosmetics.': 'Личные ежедневные предложения и косметика.',
    'The market is empty today.': 'Сегодня Чёрный рынок пуст.',
    'Refresh storefront': 'Обновить витрину',
    'Retry': 'Повторить',
    'Your storefront and stock are personal. Purchases are atomic and validated by the server.': 'Витрина и остатки персональны. Покупка проводится атомарно и проверяется сервером.',
    'Buy Black Market item?': 'Купить предмет на Чёрном рынке?',
    'The server will re-check the personal stock and currency before purchase.': 'Перед покупкой сервер повторно проверит личный остаток и баланс валюты.',
    'Confirm purchase': 'Подтвердить покупку',
    'SOLD OUT': 'РАСПРОДАНО',
    'Creator program unavailable': 'Программа авторов недоступна',
    'Application pending': 'Заявка на рассмотрении',
    'Application is under review': 'Заявка рассматривается',
    'Admin approval is required before the creator bank becomes active.': 'Банк наград станет доступен после одобрения заявки администрацией.',
    'Apply to become an official creator': 'Подать заявку в программу авторов',
    'Channel / chat': 'Канал / чат',
    'Description': 'Описание',
    'What content do you make?': 'Какой контент ты создаёшь?',
    'Submit application': 'Отправить заявку',
    'Reward bank': 'Банк наград',
    'Recent distributions': 'Последние выдачи',
    'Give': 'Выдать',
    'Creator bank is empty.': 'Банк наград пуст.',
    'No distributions yet.': 'Выдач пока нет.',
    'Give creator reward': 'Выдать награду автора',
    'Player ID': 'ID игрока',
    'Amount': 'Количество',
    'Give reward': 'Выдать награду',
    'Enter Player ID': 'Введи ID игрока',
    'You give cards': 'Ты отдаёшь карты',
    'You give currency': 'Ты отдаёшь валюту',
    'No currency': 'Без валюты',
    'Player ID · empty = public market': 'ID игрока · пусто = публичный рынок',
    'Use the Player ID shown in the other player’s profile. Leave empty to publish on the public market.': 'Используй ID из профиля другого игрока. Оставь поле пустым, чтобы разместить обмен на публичном рынке.',
    'Want currency': 'Хочу валюту',
    'You want currency': 'Ты хочешь валюту',
    'Currency': 'Валюта',
    'No assets': 'Нет предметов',
    'Cards and currencies are validated server-side': 'Карты и валюты проверяются сервером',
    'You may offer only currency, only cards, or both. Any active game currency can be requested or offered. Installed X-Factors stay attached to traded cards. Locked cards cannot be traded.': 'Можно предложить только валюту, только карты или всё вместе. Можно отдавать и запрашивать любую активную игровую валюту. Установленные X-Факторы остаются на карте. Заблокированные карты нельзя обменивать.',
    'Locked': 'Заблокирована',
    'Lock card': 'Заблокировать карту',
    'TRADE/SELL LOCKED': 'ОБМЕН/ПРОДАЖА ЗАБЛОКИРОВАНЫ',
    'Pass quests': 'Задания пасса',
    'Daily and seasonal quests award BP directly to the Fireside Season Pass.': 'Ежедневные и сезонные задания напрямую дают BP для Fireside Season Pass.',
    'CLAIMED': 'ПОЛУЧЕНО',
    'Claim': 'Забрать',
    'READY': 'ГОТОВО',
    'FREE TRACK': 'БЕСПЛАТНАЯ ЛИНИЯ',
  ...
  const patterns = [
    ...
    [/^One random card every (\d+) hours$/i, 'Одна случайная карта каждые $1 ч.'],
    [/^Current pools: (.+)$/i, 'Текущие пулы: $1'],
    [/^Next in (.+)$/i, 'Следующая через $1'],
    [/^Personal rotation · (.+)$/i, 'Личная витрина · $1'],
    [/^Claim day (\d+)$/i, 'Забрать день $1'],
    [/^(\d+) tracked$/i, 'Отслеживается: $1'],
    [/^Player ID #(\d+) · (.+)$/i, 'ID игрока #$1 · $2'],
